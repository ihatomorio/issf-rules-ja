...
d. 競技者がルール 9.4.3.1.a (最大散弾量) に従っていない弾薬を使用した場合、その選手は**失格** (**レッドカード**) とされなければなりません。

e. 競技者がルール 9.4.3.1 に従っていない弾薬を使用した場合、**警告** (**イエローカード**) を受けるか、ルール 9.4.1.d および 9.16.4.1.e に従って罰則を受けなければなりません。
